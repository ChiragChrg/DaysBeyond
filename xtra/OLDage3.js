...
function getAge() {
  ...
  function calcAge() {
    ...
    function disAge() {
      DisYear.innerHTML = `<p>${sYear} Years</p>`;
      DisMonth.innerHTML = `<p>${sMonth} Months</p>`;
      DisDay.innerHTML = `<p>${sDay} Days</p>`;
      DisHour.innerHTML = `<p>${sHour} Hours</p>`;
      DisMin.innerHTML = `<p>${sMin} Minutes</p>`;
      DisSec.innerHTML = `<p>${sSec} Seconds</p>`;
      // console.log(sYear);
    }
  }
